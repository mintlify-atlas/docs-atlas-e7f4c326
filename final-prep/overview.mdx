...
<CardGroup cols={1}>
  <Card title="TV-GAPS — The Six Cloud Advantages" icon="list-check">
  ...
  <Card title="Shared Responsibility in One Line" icon="shield-halved">
  ...
  <Card title="EC2 Pricing: O-R-S-S-D" icon="tag">
