...
description: "Survey AWS services for app integration, AI/ML, developer tools, and monitoring — SQS, SNS, SageMaker, CodePipeline, CloudWatch, and CloudTrail for the CLF-C02 exam."
---
...
<CardGroup cols={2}>
  <Card title="SQS vs SNS" icon="arrows-split-up-and-left">
  ...
  <Card title="CloudWatch vs CloudTrail" icon="eye">
  ...
  <Card title="CloudFormation vs CDK" icon="file-code">
  ...
  <Card title="Trusted Advisor vs Well-Architected" icon="shield-check">
