---
title: "AWS Database Services Guide: RDS, DynamoDB, and More"
sidebarTitle: "Databases"
description: "Master AWS database services for CLF-C02 — RDS, Aurora, DynamoDB NoSQL, DAX caching, ElastiCache, Redshift analytics, and specialty databases."
---
...
<CardGroup cols={2}>
  <Card title="Amazon RDS" icon="database" href="/technology-services/database-services">
    Managed relational databases supporting MySQL, PostgreSQL, Oracle, SQL Server, and Aurora
  </Card>
  <Card title="Amazon DynamoDB" icon="bolt" href="/technology-services/database-services">
    Serverless NoSQL key-value database delivering single-digit millisecond performance at any scale
  </Card>
  <Card title="Amazon ElastiCache" icon="memory" href="/technology-services/database-services">
    In-memory caching with Redis and Memcached for microsecond response times
  </Card>
  <Card title="Amazon Redshift" icon="chart-bar" href="/technology-services/database-services">
