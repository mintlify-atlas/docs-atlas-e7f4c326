---
title: "AWS Compute Services Guide: EC2, Lambda, and Containers"
sidebarTitle: "Compute"
description: "Master AWS compute options for CLF-C02 — EC2 instance types, Lambda serverless, ECS containers, EKS, and Fargate with all pricing models covered."
---
...
<CardGroup cols={2}>
  <Card title="Amazon EC2" icon="server" href="/technology-services/compute-services">
  ...
  <Card title="Amazon ECS / EKS" icon="boxes-stacked" href="/technology-services/compute-services">
    Managed container orchestration using Docker, ECS, and Kubernetes
  </Card>
  <Card title="AWS Fargate" icon="cloud" href="/technology-services/compute-services">
