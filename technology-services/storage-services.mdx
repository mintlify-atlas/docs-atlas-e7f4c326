---
title: "AWS Storage Services Guide: S3, EBS, EFS, and Glacier"
sidebarTitle: "Storage"
description: "Explore AWS storage for CLF-C02 — S3 storage classes and durability, EBS block volumes, EFS shared NFS, Glacier archive tiers, and Snow Family devices."
---
...
<CardGroup cols={2}>
  <Card title="Amazon S3" icon="bucket" href="/technology-services/storage-services">
    Unlimited object storage with 11 nines of durability and multiple storage class tiers
  </Card>
  <Card title="Amazon EBS" icon="hard-drive" href="/technology-services/storage-services">
    Persistent block storage volumes for EC2 with SSD and HDD options
  </Card>
  <Card title="Amazon EFS" icon="folder-open" href="/technology-services/storage-services">
    Fully managed NFS file system that scales automatically and supports concurrent access
  </Card>
  <Card title="AWS Snow Family" icon="truck" href="/technology-services/storage-services">
