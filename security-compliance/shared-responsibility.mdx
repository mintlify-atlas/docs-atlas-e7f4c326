---
title: "AWS Shared Responsibility Model Explained (CLF-C02)"
sidebarTitle: "Shared Responsibility"
description: "Understand how AWS and customers divide security duties — infrastructure, data, IAM, OS patches, and how responsibility shifts by service type."
---
...
<CardGroup cols={2}>
  <Card title="Physical Infrastructure" icon="building" href="/security-compliance/shared-responsibility">
  ...
  <Card title="Hardware & Networking" icon="server" href="/security-compliance/shared-responsibility">
  ...
  <Card title="Hypervisor & Host OS" icon="microchip" href="/security-compliance/shared-responsibility">
  ...
  <Card title="Managed Service Platforms" icon="gear" href="/security-compliance/shared-responsibility">
...
<CardGroup cols={2}>
  <Card title="Customer Data" icon="database" href="/security-compliance/shared-responsibility">
    Classifying, encrypting, and protecting your data — in transit and at rest. AWS does not encrypt your data by default.
  </Card>
  <Card title="Identity & Access Management" icon="lock" href="/security-compliance/iam-fundamentals">
    Creating IAM users, groups, and roles with least-privilege permissions. Managing MFA, access keys, and password policies.
  </Card>
  <Card title="OS Patches (IaaS)" icon="shield" href="/security-compliance/shared-responsibility">
  ...
  <Card title="Application Security" icon="code" href="/security-compliance/shared-responsibility">
    Securing the code you deploy — protecting against SQL injection, XSS, and other application-level vulnerabilities.
  </Card>
  <Card title="Network Configuration" icon="network-wired" href="/security-compliance/shared-responsibility">
    Configuring Security Groups, Network ACLs, VPC routing, and firewall rules that control traffic to your resources.
  </Card>
  <Card title="Encryption Choices" icon="key" href="/security-compliance/security-services">
