---
title: "AWS Compliance Programs, Frameworks & Artifact Guide"
sidebarTitle: "Compliance"
description: "Learn how AWS Artifact, Audit Manager, and Config Rules help meet HIPAA, PCI DSS, GDPR, and other regulatory compliance requirements on the CLF-C02 exam."
---
...
<CardGroup cols={2}>
  <Card title="Compliance Reports" icon="file-certificate" href="/security-compliance/compliance">
  ...
  <Card title="Agreements" icon="file-signature" href="/security-compliance/compliance">
...
<CardGroup cols={2}>
  <Card title="Pre-built Frameworks" icon="clipboard-check" href="/security-compliance/compliance">
  ...
  <Card title="Continuous Evidence Collection" icon="rotate" href="/security-compliance/compliance">
...
<CardGroup cols={2}>
  <Card title="AWS's Compliance Responsibilities" icon="aws" href="/security-compliance/shared-responsibility">
  ...
  <Card title="Customer's Compliance Responsibilities" icon="user" href="/security-compliance/shared-responsibility">
