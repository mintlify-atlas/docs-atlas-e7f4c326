...
<CardGroup cols={2}>
  <Card title="Visualize Costs and Usage" icon="chart-line">
  ...
  <Card title="Filter and Group" icon="filter">
  ...
  <Card title="Forecast Future Costs" icon="crystal-ball">
  ...
  <Card title="Savings Plan & RI Recommendations" icon="tags">
...
<CardGroup cols={2}>
  <Card title="EC2 Instances" icon="server">
  ...
  <Card title="Auto Scaling Groups" icon="arrows-up-down">
  ...
  <Card title="Amazon EBS Volumes" icon="hard-drive">
