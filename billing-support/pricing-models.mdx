...
description: "Master AWS EC2 pricing options, the Free Tier, S3/Lambda/RDS cost structures, and the AWS Pricing Calculator for CLF-C02 Domain 4 exam prep."
---
...
<CardGroup cols={3}>
  <Card title="Amazon S3" icon="database" href="/technology-services/storage-services">
  ...
  <Card title="Amazon RDS" icon="circle-nodes" href="/technology-services/database-services">
