...
<CardGroup cols={2}>
  <Card title="Proactive Notifications" icon="bell" href="/billing-support/support-plans">
  ...
  <Card title="Remediation Guidance" icon="wrench" href="/billing-support/support-plans">
  ...
  <Card title="Event Log" icon="clock-rotate-left" href="/billing-support/support-plans">
  ...
  <Card title="Integration Options" icon="plug" href="/billing-support/support-plans">
