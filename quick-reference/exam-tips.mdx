---
title: "AWS CLF-C02 Exam Strategy and Test-Taking Tips"
...
<CardGroup cols={2}>
  <Card title="65 Questions" icon="list-ol">
  ...
  <Card title="700 / 1000 to Pass" icon="check-circle">
  ...
  <Card title="Two Question Types" icon="circle-question">
...
<CardGroup cols={2}>
  <Card title="Shared Responsibility Model" icon="scale-balanced">
  ...
  <Card title="IAM Deep Dive" icon="user-lock">
  ...
  <Card title="EC2 Pricing Options" icon="server">
    Master all four: **On-Demand** (flexible, full price), **Reserved** (1 or 3 year commitment, up to 72% savings), **Spot** (cheapest, interruptible), and **Savings Plans** (flexible commitment discount). Match each to the correct scenario type.
  </Card>
  <Card title="S3 Storage Classes" icon="database">
  ...
  <Card title="Cloud Benefits & Deployment Models" icon="cloud">
  ...
  <Card title="Region vs AZ vs Edge Location" icon="globe">
