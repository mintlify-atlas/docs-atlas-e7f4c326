...
description: "A complete reference of every AWS service tested on the CLF-C02 exam, organized by category with key use cases for quick review."
---
...
<CardGroup cols={2}>
  <Card title="Exam Domain 3: Technology & Services" icon="microchip">
  ...
  <Card title="Study Tip: Use Cases Over Features" icon="lightbulb">
